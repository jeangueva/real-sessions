...
const TERMS: Record<Locale, LegalDocument> = {
  en: {
    ...
    sections: [
      {
        heading: "What Mockio is",
        body: [
          "A practice tool. It simulates a job interview and gives you written feedback on how you answered.",
          "It is not a recruiter, an employer, or a route to a job. We are not affiliated with, endorsed by, or acting for any company named in the product. Stripe, Amazon, Airbnb, Mercado Libre and every other employer that appears here are named only to describe the kind of interview being rehearsed — the interviewer is generated, the questions are generated, and no real employer sees anything you do here.",
          "The feedback is produced by a language model. It is often useful and it is sometimes wrong. Treat it as a second opinion on your English and your structure, not as a prediction of whether you will be hired.",
        ],
      },
      {
  ...
  es: {
    ...
    sections: [
      {
        heading: "Qué es Mockio",
        body: [
          "Una herramienta de práctica. Simula una entrevista de trabajo y te da una devolución escrita sobre cómo respondiste.",
          "No es un reclutador, ni un empleador, ni una vía para conseguir trabajo. No estamos afiliados a ninguna empresa nombrada en el producto, ni respaldados por ellas, ni actuamos en su nombre. Stripe, Amazon, Airbnb, Mercado Libre y cualquier otro empleador que aparezca acá se nombran solo para describir el tipo de entrevista que estás ensayando: el entrevistador es generado, las preguntas son generadas, y ningún empleador real ve nada de lo que hacés acá.",
          "La devolución la produce un modelo de lenguaje. Suele ser útil y a veces se equivoca. Tomala como una segunda opinión sobre tu inglés y tu estructura, no como una predicción de si te van a contratar.",
        ],
      },
      {
        heading: "Tu cuenta",
  ...
  pt: {
    ...
    sections: [
      {
        heading: "O que é o Mockio",
        body: [
          "Uma ferramenta de prática. Ela simula uma entrevista de emprego e dá uma devolutiva escrita sobre como você respondeu.",
          "Não é um recrutador, nem um empregador, nem um caminho para uma vaga. Não somos afiliados a nenhuma empresa citada no produto, nem endossados por elas, nem agimos em nome delas. Stripe, Amazon, Airbnb, Mercado Libre e qualquer outro empregador que apareça aqui são citados apenas para descrever o tipo de entrevista que você está ensaiando — o entrevistador é gerado, as perguntas são geradas, e nenhum empregador real vê nada do que você faz aqui.",
          "A devolutiva é produzida por um modelo de linguagem. Costuma ser útil e às vezes erra. Trate-a como uma segunda opinião sobre seu inglês e sua estrutura, não como uma previsão de que você será contratado.",
        ],
      },
      {
        heading: "Sua conta",
